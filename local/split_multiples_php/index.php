...
$p_base="0";
$p_currency_code='COP';
$p_description = 'Café_Tostión_Media_Alta_Molido340g_-_Medio';
$p_signature= md5($p_cust_id_cliente.'^'.$p_key.'^'.$p_id_invoice.'^'.$p_amount.'^'.$p_currency_code);
$p_split_type='03';// 01 Fijo | 02 Porcentual
...
$p_split_primary_receiver_fee='0';//Comisión del recibidor primario (App,Maketplace,Tienda,etc)
...
<input name="p_split_receivers[0][id]" type="hidden" value="41755">
<input name="p_split_receivers[0][fee]" type="hidden" value="<?php echo $p_amount ?>">
